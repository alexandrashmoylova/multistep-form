...
import ContactInfoForm from "./containers/ContactInfoForm/ContactInfoForm";
import DeliveryInfoForm from "./containers/DeliveryInfoForm/DeliveryInfoForm";
import "./app.scss";
...
const App: React.FC = () => {
  ...
  return (
    <>
      ...
      {secondStep && <button onClick={goBack}>Назад</button>}
    </>
  );
};
